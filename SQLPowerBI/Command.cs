...
namespace SQLPowerBI
{
    ...
    public class Command : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            //Create a new instance of the SQLPowerBIForm form and pass the current document as a variable
            using (System.Windows.Forms.Form form = new SQLPowerBI.Forms.SQLPowerBIForm(doc))
            {
